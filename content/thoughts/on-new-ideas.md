...
I probably don't know what I'm doing, but I decided the best solution was to migrate everything to [Hugo](https://gohugo.io). Out of the box, Hugo can handle a nested directory structure, and has a simple system for HTML layouts that makes consistent formatting easy. With Jekyll, when I wanted to create a list of all posts in a category, I needed multiple tags in the front matter and complicated loops. Hugo, on the other hand, reads my directory and does the work for me. Working with Hugo is more intuitive, adaptable, and compatible with my creative vision. So, out with Jekyll!

<!-- Currently, this site is hosted with Github Pages, but I'm looking into Cloudflare Pages as an alternative. Mainly, I think it'll be convenient to have domain and files in the same place. It doesn't really matter, so long as whatever I write can be read. -->

Having successfully transplanted my site, I've been able put the technical behind and start work on a visual redesign. My aesthetic goal is to recreate the warm and readable feel of a book&mdash;something surprisingly difficult to do on the web. [Poetry Foundation](https://www.poetryfoundation.org), one place that gets it right, has been a valuable inpiration.
